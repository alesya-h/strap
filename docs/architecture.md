...
| `STRAP_SESSION` | Active session directory | explicit env var; `strap-main` fills it from `$STRAP_WORK/sessions/current` only as an outer convenience |
