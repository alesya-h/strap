...
const projectDirs = ["agents", "commands", "tools", "porcelain", "zettel", "config", "policies"];
const workDirs = ["agents", "history", "sessions", "logs", "cache", "branches", "scratch", "commands", "tools", "porcelain", "zettel", "config"];
