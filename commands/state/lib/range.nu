...
export def fold-root [from: string, to: string, summary: string, label: string] {
  ...
  let scope = { type: "scope", label: $label, status: "collapsed", participants: $participants, summary: $summary, children: [], hidden: { children: $children } }
