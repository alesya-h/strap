...
const project_dirs = [agents skills models commands tools zettel]
const work_dirs = [agents skills models sessions logs cache branches scratch commands tools zettel]
